    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button className="bg-purple-500 text-white px-4 py-2 rounded-lg text-sm font-bold">{t("Pending (24)")}</button>
            ...
            <div className="p-6 flex-1 flex flex-col">
              <div className="flex items-start justify-between mb-2">
                <div>
                  ...
                  <p className="text-slate-400 text-sm">{t("by")} {book.author}</p>
                </div>
                <span className="text-xs font-bold px-2 py-1 rounded-lg bg-orange-400/10 text-orange-400 uppercase">{t("Pending")}</span>
              </div>
              <p className="text-slate-500 text-sm mb-6 line-clamp-3">
                {t("A deep dive into the themes of {category} and how it shapes our modern digital age.", { category: book.category.toLowerCase() })}
              </p>
