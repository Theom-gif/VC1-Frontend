  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard label={t("Total Users")} value="12,483" trend="+342" icon={Users} color="bg-purple-500" />
        <StatCard label={t("Total Books")} value="2,847" trend="+127" icon={BookOpen} color="bg-pink-500" />
        <StatCard label={t("Pending Approvals")} value="24" trend="-4" icon={CheckSquare} color="bg-orange-500" />
        <StatCard label={t("Authors")} value="1,234" trend="+89" icon={Grid} color="bg-green-500" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="glass-card p-6 flex flex-col">
          ...
          <div className="space-y-1 mb-8">
            <HealthItem label={t("API Server")} value={t("12ms latency")} status="online" icon={Server} />
            <HealthItem label={t("Database")} value={t("4ms query time")} status="online" icon={Database} />
            <HealthItem label={t("File Storage")} value={t("78% used")} status="warning" icon={HardDrive} />
            <HealthItem label={t("Email Service")} value={t("67ms response")} status="online" icon={Mail} />
          </div>
